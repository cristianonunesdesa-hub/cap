...
import { X, Copy, Check, RefreshCcw } from './Icons';
        ...
        <div className="p-4 border-t border-gray-200 bg-gray-50">
          ...
          <div className="flex gap-3">
            <button
              ...
              className={`flex-1 flex items-center justify-center px-4 py-2 rounded-md text-white transition-colors font-medium shadow-sm ${copied ? 'bg-green-600' : 'bg-green-600 hover:bg-green-700 disabled:bg-gray-300'
                }`}
            >
