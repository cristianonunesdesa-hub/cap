...
import { RefreshCcw, MessageCircle, Calendar, AlertTriangle, Edit, Users, Archive } from './Icons';
        ...
        return (
          <div key={customer.id} className={`transition-colors ${isExpanded ? 'bg-blue-50' : 'hover:bg-gray-50'}`}>
            ...
            >
                ...
                {/* Coluna 2: Contato */}
                <div className="md:col-span-3 text-sm text-gray-600 flex items-center gap-2 md:block">
